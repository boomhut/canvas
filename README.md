...
**[User guide](https://github.com/boomhut/canvas/wiki)**

**[Live HTMLCanvas demo](https://tdewolff.github.io/canvas/examples/html-canvas/index.html)**

**[Benchmarks](https://github.com/boomhut/canvas_benchmarks)**
...
Please issue bug reports or feature requests to help this library mature! All help is appreciated. Also see [Wiki - Planning](https://github.com/boomhut/canvas/wiki/Planning) for an inexhaustive list of ideas and TODOs.

## Features
### General
- Path segment types: MoveTo, LineTo, QuadTo, CubeTo, ArcTo, Close (see [Paths](https://github.com/boomhut/canvas/wiki/Paths))
...
See [Renderers](https://github.com/boomhut/canvas/wiki/Renderers) for more information.
...
See [Benchmarks](https://github.com/boomhut/canvas_benchmarks) for a comparison with other libraries.

See [Boolean operations](https://github.com/boomhut/canvas/wiki/Boolean-operations) for more information.
...
Additionally, many font formats are supported (such as TTF, OTF, WOFF, WOFF2, EOT) and rendering can apply a gamma correction of 1.43 for better results. See [Fonts & Text](https://github.com/boomhut/canvas/wiki/Fonts-&-Text) for more information.

## Examples

**[Amsterdam city centre](https://github.com/boomhut/canvas/tree/master/examples/amsterdam-centre)**: the centre of Amsterdam is drawn from data loaded from the Open Street Map API.

**[Chile over Europe](https://github.com/boomhut/canvas/tree/master/examples/chile)**: the size of Chile overlaying Europe in their respective UTM projections.

**[Mauna-Loa CO2 concentration](https://github.com/boomhut/canvas/tree/master/examples/co2-mauna-loa)**: using data from the Mauna-Loa observatory, carbon dioxide concentrations over time are drawn

**[Text document](https://github.com/boomhut/canvas/tree/master/examples/text-document)**: an example of a text document using the PDF backend.

**[OpenGL](https://github.com/boomhut/canvas/tree/master/examples/opengl)**: an example using the OpenGL backend.

**[Gio](https://github.com/boomhut/canvas/tree/master/examples/gio)**: an example using the Gio backend.

**[Fyne](https://github.com/boomhut/canvas/tree/master/examples/fyne)**: an example using the Fyne backend.

**[TeX/PGF](https://github.com/boomhut/canvas/tree/master/examples/tex)**: an example showing the usage of the PGF (TikZ) LaTeX package as renderer in order to generated a PDF using LaTeX.

**[go-chart](https://github.com/boomhut/canvas/tree/master/examples/go-chart)**: an example using the [go-chart](https://github.com/wcharczuk/go-chart) library, plotting a financial graph.

**[gonum/plot](https://github.com/boomhut/canvas/tree/master/examples/gonum-plot)**: an example using the [gonum/plot](https://github.com/gonum/plot) library.

**[HTMLCanvas](https://github.com/boomhut/canvas/tree/master/examples/html-canvas)**: an example using the HTMLCanvas backend, see the [live demo](https://tdewolff.github.io/canvas/examples/html-canvas/index.html).
